...
public class ArrayGroupTest {
    ...
    public void setUp() {
        ...
        keys1 = new String[] { "1991", "1994", "1995", "1997", "1999", "2000", "2003", "2004", "2005", "2008" };
    ...
    public void testBeginIn1990Member1() { 
        String[] testKeys = { "1991", "1992", "1993", "1994", "1995", "1996", "1997", "1998", "1999", "2000" };
        ...
        assertDoubleArrayEquals(testValues, g.getValueGroup());
    }
    ...
    public void testBeginIn1991Member2() {
        String[] testKeys = new String[] { "1991-1992", "1993-1994", "1995-1996", "1997-1998", "1999-2000" };
    ...
    public void testBeginIn1992Member2() {
        String[] testKeys = new String[] { "1992-1993", "1994-1995", "1996-1997", "1998-1999", "2000-2001" };
    ...
    public void testBeginIn1991Member1NotContiguous() {
        String[] testKeys = new String[] { "1991", "1994", "1995", "1997", "1999", "2000", "2003", "2004", "2005",
                "2008" };
    ...
    public void testBeginIn1991Member2NotCongiguous() {
        String[] testKeys = new String[] { "1991-1992", "1993-1994", "1995-1996", "1997-1998", "1999-2000", "2001-2002",
    ...
    public void testBeginIn1991Member3NotContiguous() {
        String[] testKeys = new String[] { "1991-1993", "1994-1996", "1997-1999", "2000-2002", "2003-2005",
                "2006-2008" };
    ...
    public void testBeginIn1991Member4NotContiguous() {
        String[] testKeys = new String[] { "1991-1994", "1995-1998", "1999-2002", "2003-2006", "2007-2010" };
 ...
 // String[] testKeys = new String[] { "1994", "1995", "1997",
    // "1999", "2000", "2003", "2004", "2005",
    // "2008" };
    // double[] testValues = new double[] { 80, 99, 5, 24, 18, 22, 33, 55,
    // 100 };
 // String[] testKeys = new String[] { "1994", "1995", "1997",
    // "1999", "2000", "2003", "2004", "2005",
    // "2008" };
    ...
    public void testBeginIn1992Member2NotContiguous() {
        String[] testKeys = new String[] { "1992-1993", "1994-1995", "1996-1997", "1998-1999", "2000-2001", "2002-2003", "2004-2005", "2006-2007", "2008-2009" };
        double[] testValues = { 0, 179, 5, 24, 18, 0, 42, 22, 88, 100 };
    ...
    public void testBeginIn1992Member3NotContiguous() {
        String[] testKeys = new String[] { "1992-1994", "1995-1997", "1998-2000", "2001-2003", "2004-2006", "2007-2009" };
    ...
    public void testBeginIn1992Member4NotContiguous() {
        String[] testKeys = new String[] { "1992-1995", "1996-1999", "2000-2003", "2004-2007", "2008-2011" };
        double[] testValues = { 179, 29, 40, 88, 100 };
